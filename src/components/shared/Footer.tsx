          ...
          <div className="w-3/12">
            ...
            <div className="flex flex-col gap-1 pt-6">
              ...
              <div className="flex items-center gap-4">
                ...
                <Mail
                  strokeWidth={1.8}
                  className="size-7 text-white/90 cursor-pointer"
                />
          ...
          <div>
            ...
            <div className="pt-4">
              <div className="bg-white py-1 rounded-lg flex items-center w-fit px-2 ">
                <input
                  className="focus:outline-none text-sm px-2"
                  type="email"
                  name=""
                  id=""
                />
                <button className="text-white text-sm cursor-pointer bg-black px-4 py-2 rounded-lg">
                  Send
                </button>
              </div>
            </div>
