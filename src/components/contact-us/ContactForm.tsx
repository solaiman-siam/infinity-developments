        ...
        <form action="" className="space-y-5">
          ...
          <div className="flex flex-col gap-2">
            ...
            <input
              ...
              className="px-3 placeholder:text-sm focus:border-white/60 transition-all duration-20 bg-white/20 py-2.5 text-[15px] font-thin rounded-md border focus:outline-none border-white/40"
              type="text"
              id=""
            />
          </div>
          ...
          <div className="pt-4">
            <Checkbox className="!size-6 text-nowrap !text-[15px] !font-thin" onChange={onCheckboxChange}>I have read and agree to the privacy policy.*</Checkbox>
          </div>

          <div className="flex justify-center mt-8">
            <button className="flex items-center gap-3 group rounded-lg cursor-pointer justify-center bg-primaryBlack text-white w-96 h-12">Send Message <FaArrowRightLong className="group-hover:translate-x-2 transition-all duration-300" /></button>
          </div>
        </form>
      </div>
    </div>
